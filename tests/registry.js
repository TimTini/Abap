...
const entries = [
  ...
  { file: "tests/viewer-contracts.perform.test.js", suites: ["viewer", "contracts", "fast", "full"], labels: ["if-template", "perform-root-trace", "perform-source-selection", "perform-source-picker", "template-header-compact", "template-multi-value-perform-call", "template-multi-value-perform-root", "data-perform-trace", "description-scope"] },
