...
const entries = [
  ...
  { file: "tests/viewer-contracts.perform.test.js", suites: ["viewer", "contracts", "fast", "full"], labels: ["if-template", "perform-root-trace", "perform-source-selection", "template-multi-value-perform-call", "template-multi-value-perform-root", "data-perform-trace"] },
  { file: "tests/viewer-contracts.template.test.js", suites: ["viewer", "contracts", "fast", "full"], labels: ["struct-field-finaldesc", "constant-finaldesc", "template-multi-value-conditions", "template-multi-value-safe-lists", "template-row-description-loop", "template-row-description-perform", "template-row-description-condition", "template-provenance", "append-variants", "template-multi-select", "message-write"] },
