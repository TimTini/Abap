...
window.AbapViewerRuntime.api = window.AbapViewerRuntime.api || {};
  ...
  const SAMPLE_ABAP = [
    ...
    "",
    "*---------------------------------------------------------------------*",
    "* CHECK: Description Target vs PERFORM nguồn (manual QA)",
    "* CASE 1: FORM gọi 1 lần — Description KHÔNG hiện Target (gv/iv cùng chain)",
    "* CASE 2: DATA local trong FORM — 1 decl, không Target",
    "* CASE 3: FORM gọi 2 lần — card PERFORM hiện ⇄ 2 nguồn",
    "* CASE 4: Nested PERFORM + multi nguồn outer",
    "* CASE 5: Literal — Description khóa",
    "* CASE 6: IF 2 biến khác nhau — Target left/right nếu cần",
    "*---------------------------------------------------------------------*",
    "DATA:",
    "  gv_chk_once  TYPE string, \"CHK Root once\"",
    "  gv_chk_a     TYPE string, \"CHK Root A\"",
    "  gv_chk_b     TYPE string, \"CHK Root B\"",
    "  gv_chk_n1    TYPE string, \"CHK Nest one\"",
    "  gv_chk_n2    TYPE string, \"CHK Nest two\"",
    "  gv_chk_left  TYPE string, \"CHK Left op\"",
    "  gv_chk_right TYPE string. \"CHK Right op\"",
    "",
    "*---------------------------------------------------------------------*",
    "* INITIALIZATION",
    "*---------------------------------------------------------------------*",
    ...
    "",
    "  \" CHECK: Description Target vs PERFORM nguồn (manual QA)",
    "  PERFORM frm_chk_once USING gv_chk_once.",
    "  PERFORM frm_chk_multi USING gv_chk_a.",
    "  PERFORM frm_chk_multi USING gv_chk_b.",
    "  PERFORM frm_chk_outer USING gv_chk_n1 gv_chk_n2.",
    "  PERFORM frm_chk_outer USING gv_chk_n2 gv_chk_n1.",
    "  PERFORM frm_chk_lit USING 'X'.",
    "  IF gv_chk_left = gv_chk_right.",
    "  ENDIF.",
    "",
    "*---------------------------------------------------------------------*",
    "* END-OF-SELECTION",
    ...
    "",
    "*---------------------------------------------------------------------*",
    "* CHECK FORMs: Description Target vs PERFORM nguồn (manual QA)",
    "*---------------------------------------------------------------------*",
    "FORM frm_chk_once USING iv_chk_once TYPE string.",
    "  DATA lv_chk_local TYPE string. \"CHK Local once\"",
    "  lv_chk_local = iv_chk_once.",
    "  CLEAR iv_chk_once.",
    "ENDFORM.",
    "",
    "FORM frm_chk_multi USING iv_chk_multi TYPE string.",
    "  CLEAR iv_chk_multi.",
    "ENDFORM.",
    "",
    "FORM frm_chk_outer USING iv_chk_o1 TYPE string iv_chk_o2 TYPE string.",
    "  PERFORM frm_chk_inner USING iv_chk_o1 iv_chk_o2.",
    "ENDFORM.",
    "",
    "FORM frm_chk_inner USING iv_chk_i1 TYPE string iv_chk_i2 TYPE string.",
    "  CLEAR iv_chk_i1.",
    "  CLEAR iv_chk_i2.",
    "ENDFORM.",
    "",
    "FORM frm_chk_lit USING iv_chk_lit TYPE string.",
    "  CLEAR iv_chk_lit.",
    "ENDFORM."
  ].join("\n");
